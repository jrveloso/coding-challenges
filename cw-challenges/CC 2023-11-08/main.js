...
// "It costs tree fiddy" -> true
// "It costs 3.50" -> true
// "What's the weather?" -> false

const isLockNessMonster= s => s.includes("3.50") || s.includes("tree fiddy")

console.log(isLockNessMonster("It costs tree fiddy"), true)
console.log(isLockNessMonster("It costs 3.50"), true)
console.log(isLockNessMonster("What's the weather?"), false)
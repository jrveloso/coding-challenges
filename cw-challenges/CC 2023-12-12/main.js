...
// address, n (# of houses) -> h (house number on opposite side of street)
...
function overTheRoad(address, n) {
  // Given your house address and length of street
  // Divide and conquer strategy
  // Find total # of houses
  // Divide by address

  // Return house number opposite side
